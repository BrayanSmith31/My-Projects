...
def get_data():
    ...
    # PATH_DIR=os.path.join(BASE_DIR,"cache")
    # os.makedirs(PATH_DIR,exist_ok=True)
    # filepath=os.path.join("cache", "crypto_data.html")
    # data=df.to_html(filepath, index= False)
...
# df_change
# df_change[["positive_percent_change_7d","coin_symbol"]]
#Bar chart
